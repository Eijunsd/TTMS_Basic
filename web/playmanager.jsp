...
<div class="tab-content">
    ...
    <div class="tab-movie-list" style="width: 1050px">
        ...
        <div class="movie-card-wrap">
            <a href="moiveP2.html" class="movie-card">
                <div class="movie-card-tag"><i class="t-"></i></div>
                <div class="movie-card-poster">
                    <img width="160" height="224" src="../../image/hero.jpg">
                </div>
                <div class="movie-card-name">
                    <span class="bt-l">厕所英雄</span>
                    <span class="bt-r">8.4</span>
                </div>
                <div class="movie-card-info" >
                    <div class="movie-card-mask"></div>
                    <div class="movie-card-list">
                        <span>导演：什里&middot;那拉扬&middot;辛</span>
                        <span>主演：阿克谢&middot;库玛尔,布米&middot;佩德卡尔,阿努潘&middot;凯尔,迪韦严杜&middot;沙玛,萨钦&middot;克德卡</span>
                        <span>类型：剧情,喜剧</span>
                        <span>地区：印度</span>
                        <span>语言：印地语</span>
                        <span>片长：150分钟</span>                        </div>
                </div>
            </a>
            <a href="moiveP2.html" class="movie-card-buy">选座购票</a>
        </div>
        <div class="movie-card-wrap">
            <a href="moiveP2.html" class="movie-card">
                <div class="movie-card-tag"><i class="t-"></i></div>
                <div class="movie-card-poster">
                    <img width="160" height="224" src="../../image/come.jpg">
                </div>
                <div class="movie-card-name">
                    <span class="bt-l">幸福马上来</span>
                    <span class="bt-r">7.6</span>
                </div>
                <div class="movie-card-info">
                    <div class="movie-card-mask"></div>
                    <div class="movie-card-list">
                        <span>导演：冯巩, 崔俊杰</span>
                        <span>主演：冯巩,刘昊然,岳云鹏,毛俊杰,贾玲</span>
                        <span>类型：喜剧</span>
                        <span>地区：中国大陆</span>
                        <span>语言：汉语普通话</span>
                        <span>片长：91分钟</span>                        </div>
                </div>
            </a>
            <a href="playManagement.html" class="movie-card-buy">选座购票</a>
        </div>
        <div class="movie-card-wrap">
            <a href="playManagement.html" class="movie-card">
                <div class="movie-card-tag"><i class="t-103"></i></div>
                <div class="movie-card-poster">
                    <img width="160" height="224"  src="../../image/zhuluoji.jpg">
                </div>
                <div class="movie-card-name">
                ...
                <div class="movie-card-info">
                    ...
                    <div class="movie-card-list">
                        ...
                        <span>主演：克里斯&middot;帕拉特,布莱丝&middot;达拉斯&middot;霍华德,贾斯提斯&middot;史密斯,拉菲&middot;斯波</span>
                        <span>类型：史诗,动作,冒险</span>
                        <span>地区：美国</span>
                        <span>语言：英语</span>
        ...
        <div class="movie-card-wrap">
            <a href="moiveP2.html" class="movie-card">
                <div class="movie-card-tag"><i class="t-"></i></div>
                <div class="movie-card-poster">
                    <img width="160" height="224" src="../../image/chaoshikong.jpg">
                </div>
                <div class="movie-card-name">
                    <span class="bt-l">超时空同居</span>
                ...
                <div class="movie-card-info">
                    ...
                    <div class="movie-card-list">
                        <span>导演：苏伦</span>
                        <span>主演：雷佳音,佟丽娅,陶虹,徐峥</span>
                        <span>类型：喜剧,奇幻</span>
                        <span>地区：中国大陆</span>
                        <span>语言：汉语普通话</span>
                        <span>片长：100分钟</span>                        </div>
                </div>
            </a>
            <a href="movieProduce.html" class="movie-card-buy">选座购票</a>
        </div>
