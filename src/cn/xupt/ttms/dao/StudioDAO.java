...
//                studio.setStudioId(rs.getInt("studio_id"));
    ...
    public boolean insert(Studio studio)
    {
        ...
        try
        {
            ...
            pstmt.setInt(3, studio.getStudioRowCount());
            pstmt.setInt(4, studio.getStudioColCount());
            pstmt.setString(5, studio.getStudioIntroduction());
            pstmt.setInt(6, studio.getStudioFlag());
